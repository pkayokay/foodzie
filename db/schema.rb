...
ActiveRecord::Schema.define(version: 20161112200845) do
  ...
  create_table "places", force: true do |t|
    ...
    t.datetime "updated_at"
    t.integer  "user_id"
    t.string   "defaultpicture"
    t.float    "latitude"
    t.float    "longitude"
    t.string   "slug"
  end

  add_index "places", ["defaultpicture"], name: "index_places_on_defaultpicture", using: :btree
